...
full_results_LOADED = {}
# full_results_LOADED = pickle.load(open("O2_LAMOD_DistanceMeasures_LOADED_1606761720.9927037.pkl", "rb"))
full_results_LOADED = pickle.load(open("O2_LAMOD_DistanceMeasures_LOADED_1606768107.3545783.pkl", "rb"))
# print("++++++++++")
...
threshold_val = 0.5
filtered_results = filter_results(full_results_LOADED, threshold_val, greater_than, sim_measure='lamod')
# print("++++++++++")
...
pattern_prec_recall = pattern_precision_recall(full_results_LOADED, melody_dict_LOADED, sim_phrase_true_dict, 'lamod', "ann1")
# print("++++++++++")
# print("*****PRECRECALL*****")
...
for ev in ann_values_sim_dict_for_roc:
  for annotation in ev['position_eval']:
    ...
    lamod_labels.append(annotation['lamod'])
# print(ann1_labels)
# print(lamod_labels)
...
fpr, tpr, _ = roc_curve(ann1_labels, lamod_labels)
roc_auc = auc(fpr, tpr)
plt.figure()
lw = 2
