...
from find_matches import distance_measures, matches_in_corpus, local_aligner_mod, local_aligner_mod_tempo
import json
import time
import pickle
...
full_results = matches_in_corpus(melody_dict_LOADED, phrase_dict_LOADED, measure=local_aligner_mod_tempo)
ts = time.time()

pickle.dump(full_results, open('./O2_LAMODTEMPO_DistanceMeasures_NO_LOADED_{0}.pkl'.format(str(ts)), "wb"))