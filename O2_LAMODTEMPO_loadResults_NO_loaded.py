...
full_results_LOADED = pickle.load(open("O2_LAMODTEMPO_DistanceMeasures_NO_LOADED_1606940005.6477442.pkl", "rb")) # 1_64
...
fpr, tpr, _ = roc_curve(ann1_labels, lamodtempo_labels)
roc_auc = auc(fpr, tpr)
plt.figure()
lw = 2
