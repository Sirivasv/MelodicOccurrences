...
full_results = matches_in_corpus(melody_dict_LOADED, phrase_dict_LOADED)
ts = time.time()

pickle.dump(full_results, open('./O2_LA_DistanceMeasures_NO_LOADED_{0}.pkl'.format(str(ts)), "wb"))