...
full_results_LOADED = {}
full_results_LOADED = pickle.load(open("O2_LA_DistanceMeasures_NO_LOADED_1606937553.8105748.pkl", "rb"))
# print("++++++++++")
...
threshold_val = 0.5
filtered_results = filter_results(full_results_LOADED, threshold_val, greater_than, sim_measure='la')
# print("++++++++++")
...
pattern_prec_recall = pattern_precision_recall(full_results_LOADED, melody_dict_LOADED, sim_phrase_true_dict, 'la', "ann1")
# print("++++++++++")
# print("*****PRECRECALL*****")
...
for ev in ann_values_sim_dict_for_roc:
  for annotation in ev['position_eval']:
    ...
    la_labels.append(annotation['la'])
# print(ann1_labels)
# print(la_labels)
...
fpr, tpr, _ = roc_curve(ann1_labels, la_labels)
roc_auc = auc(fpr, tpr)
plt.figure()
lw = 2
