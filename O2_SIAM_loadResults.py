...
full_results_LOADED = {}
full_results_LOADED = pickle.load(open("O2_SIAM_DistanceMeasures_LOADED_1606755597.5134878.pkl", "rb"))
# print("++++++++++")
...
threshold_val = 0.5
filtered_results = filter_results(full_results_LOADED, threshold_val, greater_than, sim_measure='siam')
# print("++++++++++")
...
pattern_prec_recall = pattern_precision_recall(full_results_LOADED, melody_dict_LOADED, sim_phrase_true_dict, 'siam', "ann1")
# print("++++++++++")
# print("*****PRECRECALL*****")
...
for ev in ann_values_sim_dict_for_roc:
  for annotation in ev['position_eval']:
    ...
    siam_labels.append(annotation['siam'])
# print(ann1_labels)
# print(siam_labels)
...
fpr, tpr, _ = roc_curve(ann1_labels, siam_labels)
roc_auc = auc(fpr, tpr)
plt.figure()
lw = 2
