...
from find_matches import distance_measures, matches_in_corpus
import json
import time
import pickle
...
full_results = matches_in_corpus(melody_dict_LOADED, phrase_dict_LOADED, measure=distance_measures)
ts = time.time()

pickle.dump(full_results, open('./O2_DMS_DistanceMeasures_LOADED_{0}.pkl'.format(str(ts)), "wb"))