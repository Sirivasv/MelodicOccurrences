...
threshold_val = 0.5
filtered_results = filter_results(full_results_LOADED, threshold_val, greater_than, sim_measure='ed')
# print("++++++++++")
...
pattern_prec_recall = pattern_precision_recall(full_results_LOADED, melody_dict_LOADED, sim_phrase_true_dict, 'ed', "ann1")
# print("++++++++++")
# print("*****PRECRECALL*****")
...
fpr, tpr, _ = roc_curve(ann1_labels, ed_labels)
roc_auc = auc(fpr, tpr)
plt.figure()
lw = 2
