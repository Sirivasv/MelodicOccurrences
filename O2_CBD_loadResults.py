...
threshold_val = 0.5
filtered_results = filter_results(full_results_LOADED, threshold_val, greater_than, sim_measure='cbd')
# print("++++++++++")
...
pattern_prec_recall = pattern_precision_recall(full_results_LOADED, melody_dict_LOADED, sim_phrase_true_dict, 'cbd', "ann1")
# print("++++++++++")
# print("*****PRECRECALL*****")
...
for ev in ann_values_sim_dict_for_roc:
  for annotation in ev['position_eval']:
    ...
    cbd_labels.append(annotation['cbd'])
# print(ann1_labels)
# print(cbd_labels)
...
fpr, tpr, _ = roc_curve(ann1_labels, cbd_labels)
roc_auc = auc(fpr, tpr)
plt.figure()
lw = 2
